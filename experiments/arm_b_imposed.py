...
This is the live-LLM replication of F1 (breach rate 9.9% -> 0%, settlement and
surplus preserved) with the scripted concession model replaced by whatever the
LLM actually does, and it is the arm that carries the section 11 report.
